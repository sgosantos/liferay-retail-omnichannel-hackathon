...
public class ShoppingService extends BaseService {
	...
	public JSONObject updateUserOrdersToDeliver(
		long groupId, long userId) throws Exception {
		...
		try {
			...
			_command.put("/shopping.shoppingorder/update-user-orders-to-deliver", _params);
		}
